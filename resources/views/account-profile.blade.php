				...
				<div class="col-sm-12 col-lg-3 p-5 p-b-40">
					...
					<div class="row my-2 justify-content-center">
						<div class="col-11 my-2">
							<a href="{{ route('account-profile') }}" style="text-decoration: none;" class="account-active">
						...
						<div class="col-11 my-2">
							<a href="{{ route('account-password') }}" style="text-decoration: none;" class="account-menu">
						...
						<div class="row my-2 justify-content-center">
							<div class="col-sm-12 col-lg-11">
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="text" class="text-dark" name="username" value="{{$customer[0]->CUST_USERNAME}}" required>
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="text" class="text-dark" name="name" value="{{$customer[0]->CUST_NAME}}" required>
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
									...
									<div class="col-sm-5 col-lg-3 px-3">
										<input type="radio" style="display: inline;" name="gender" value="M" required {{ $customer[0]->CUST_GENDER === 'M' ? 'checked' : '' }}> Male
									</div>
									<div class="col-sm-5 col-lg-3 px-3">
										<input type="radio" style="display: inline;" name="gender" value="F" required {{ $customer[0]->CUST_GENDER === 'F' ? 'checked' : '' }}> Female
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="text" class="text-dark" name="email" value="{{$customer[0]->CUST_EMAIL}}" required>
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
								...
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="text" class="text-dark" name="phone" value="{{$customer[0]->CUST_PHONE}}" required>
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="submit" value="UPDATE" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									</div>
								</div>
							</div>
						</div>
		...
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					</script> All rights reserved | Made by MonoMode</a>
