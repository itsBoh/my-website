				...
				<div class="col-sm-12 col-lg-3 p-5 p-b-40">
					...
					<div class="row my-2 justify-content-center">
						<div class="col-11 my-2">
							<a href="{{ url('./account') }}" style="text-decoration: none;" class="account-menu">
								<img src="{{ asset('/images/user.png') }}" alt="" width="16px" height="16px">
								<span class="px-2">Profile</span>
							</a>
						</div>
						<div class="col-11 my-2">
							<a href="{{ url('./account-transaction') }}" style="text-decoration: none;" class="account-active">
								<img src="{{ asset('/images/notebook.png') }}" alt="" width="16px" height="16px">
								<span class="px-2">Transaction</span>
							</a>
						</div>
						<div class="col-11 my-2">
							<a href="{{ url('./account-password') }}" style="text-decoration: none;" class="account-menu">
					...
					<div class="row my-2 justify-content-center">
						<div class="col-12">
							<!-- <div class="row align-items-center" style="height: 100px;">
								<div class="col-2">
									<p>Paid</p>
									<p class="trans-date">12-02-2023</p>
								</div>
								<div class="col-5">
									<img src="{{ asset('/images/gallery-03.jpg') }}" alt="" class="trans-prod">
									Denim Hoodie
								</div>
								<div class="col-2 text-center">
									1
							...
							<div class="row align-items-center" style="height: 100px;">
								<div class="col-2">
									...
									<p class="trans-date">{{ $tran->date}}</p>
								</div>
								<div class="col-5">
									<img src="{{ asset('/images/gallery-03.jpg') }}" alt="" class="trans-prod">
									{{$tran->name}}
