				...
				<div class="col-sm-12 col-lg-3 p-5 p-b-40">
					...
					<div class="row my-2 justify-content-center">
						<div class="col-11 my-2">
							<a href="{{ url('./account-profile') }}" style="text-decoration: none;" class="account-menu">
								<img src="{{ asset('/images/user.png') }}" alt="" width="16px" height="16px">
								<span class="px-2">Profile</span>
							</a>
						</div>
						<div class="col-11 my-2">
							<a href="{{ url('./account-transaction') }}" style="text-decoration: none;" class="account-menu">
								<img src="{{ asset('/images/notebook.png') }}" alt="" width="16px" height="16px">
								<span class="px-2">Transaction</span>
							</a>
						</div>
						<div class="col-11 my-2">
							<a href="{{ url('./account-password') }}" style="text-decoration: none;" class="account-active">
							...
							<div class="col-sm-12 col-lg-11">
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="password" class="text-dark">
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
								...
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="password" style="display: inline;">
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
