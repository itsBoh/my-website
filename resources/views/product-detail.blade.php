...
<body class="animsition">
				...
				<div class="col-md-6 col-lg-7 p-b-30">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							$imgsrc = asset($filename . '.jpg');
							$imgsrc2 = $filename.'.jpg';
							}
							}
							@endphp
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="{{ $imgsrc2}}">
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			...
			const upButton = document.querySelector('.btn-num-product-up');
			const downButton = document.querySelector('.btn-num-product-down');
