...
<body class="animsition">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							Rp {{number_format($products[0]->PROD_PRICE, 0, ',', '.')}}
						</span>

						<p class="stext-102 cl3 p-t-23">
							{{$products[0]->PROD_DESC}}
						</p>
						...
						<div class="p-t-33">
							...
							<form action="{{ route('product-cart')}}" method="post" id="add-to-cart-form">
								@csrf
								<div class="flex-w flex-r-m p-b-10">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="{{ url('#description') }}" role="tab">Description</a>
						</li>

						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="{{ url('#information') }}" role="tab">Additional
								information</a>
						</li>

						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="{{ url('#reviews') }}" role="tab">Reviews (1)</a>
						</li>
					</ul>
	...
	<!-- sl;jkghnjksdafhgjihdasfgas -->
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			var minusButton = document.querySelector('.btn-num-product-down');
			var plusButton = document.querySelector('.btn-num-product-up');
			var form = document.querySelector('#add-to-cart-form');

			minusButton.addEventListener('click', function(event) {
				event.preventDefault();
				var input = form.querySelector('.num-product');
				input.stepDown();
			});
