			...
			<div class="row text-dark justify-content-center">
				<div class="col-sm-12 col-lg-3 p-5 p-b-40">
					...
					<div class="row my-2 justify-content-center">
						...
						<div class="col-11 my-2">
							<a href="{{ route('account-transaction') }}" style="text-decoration: none;" class="account-active">
						...
						<div class="col-12">
							...
							<div class="row align-items-center" style="height: 100px;">
								...
								<div class="col-5">
									...
									@php
									$filename = '/images/product/' . $tran->id . ' ' . $tran->name . '/' . $tran->id . '_1';
									$imgsrc = asset($filename . '.png');
									...
									@endphp
									<img src="{{ $imgsrc }}" alt="IMG" class="trans-prod">
									{{$tran->name}}
								</div>
								<div class="col-2 text-center">
									{{$tran->quantity}}
							...
							<!-- <div class="row align-items-center" style="height: 100px;">
								<div class="col-2">
									<p>Paid</p>
									<p class="trans-date">21-05-2023</p>
								</div>
								<div class="col-5">
									<img src="{{ asset('/images/gallery-03.jpg') }}" alt="" class="trans-prod">
									Denim Hoodie
