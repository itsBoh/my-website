...
(function ($) {
    ...
    $('.js-show-sidebar-wishlist').on('click', function () {
        $('.js-sidebar-wishlist').addClass('show-sidebar-wishlist');
    });

    $('.js-hide-sidebar-wishlist').on('click', function () {
        $('.js-sidebar-wishlist').removeClass('show-sidebar-wishlist');
    });
    ...
    addToCartButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            console.log(shoppingCart); // replace this with code to update the shopping cart UI
        });
    });
